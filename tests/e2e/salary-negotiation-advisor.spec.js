...
const SVC_URL = "https://appadaycreator.com/salary-negotiation-advisor/";
const SVC_NAME = "給与交渉シミュレーター";

test.describe("給与交渉シミュレーター - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("salary-negotiation-advisor");
